...
jobs = [
  ...
  { :timestamp => 1405335219583, :title => "Title 1", :full_name => "Hurst Elliott", :email => "hurstelliott@overplex.com", :phone => "924 423 3366", :contact => "hurstelliott@overplex.com", :section => "Sports", :coverage_type => "Action", :due_date => "2014-08-31", :due_time => "10:00", :details => "Sunt pariatur dolore quis eu cillum enim in et tempor elit.", :state => 0, :loc => 'Goddard', :date => '2015-01-30', :time => '10:00' },
  { :timestamp => 1407155275282, :title => "Title 2", :full_name => "Susana Franklin", :email => "susanafranklin@overplex.com", :phone => "978 427 2685", :contact => "susanafranklin@overplex.com", :section => "Sports", :coverage_type => "Action", :due_date => "2014-08-31", :due_time => "10:00", :details => "Velit laboris fugiat id proident sunt dolor fugiat aliqua et nisi laboris eiusmod eiusmod.", :state => 3, :loc => 'Carm Lounge', :date => '2014-11-10', :time => '' },
  { :timestamp => 1405899554503, :title => "Title 3", :full_name => "Augusta Solis", :email => "augustasolis@overplex.com", :phone => "968 585 2291", :contact => "augustasolis@overplex.com", :section => "Sports", :coverage_type => "Action", :due_date => "2014-08-31", :due_time => "10:00", :details => "Commodo irure laborum consectetur aute mollit adipisicing excepteur.", :state => 1, :loc => '', :date => '', :time => '', :daily_member_id => DailyMember.second.id },
  { :timestamp => 1405985506198, :title => "Title 4", :full_name => "Noemi Shaw", :email => "noemishaw@overplex.com", :phone => "924 527 3493", :contact => "noemishaw@overplex.com", :section => "Sports", :coverage_type => "Action", :due_date => "2014-08-31", :due_time => "10:00", :details => "Sunt exercitation id cupidatat aliqua ipsum cillum cupidatat sit quis eiusmod dolore et.", :state => 0, :loc => '', :date => '', :time => '' },
  { :timestamp => 1406750549992, :title => "Title 5", :full_name => "Daisy Cooley", :email => "daisycooley@overplex.com", :phone => "969 593 3713", :contact => "daisycooley@overplex.com", :section => "Sports", :coverage_type => "Action", :due_date => "2014-08-31", :due_time => "10:00", :details => "Velit do pariatur cillum amet enim occaecat enim labore incididunt sint excepteur quis.", :state => 0, :loc => '', :date => '', :time => '' },
  { :timestamp => 1406197965080, :title => "Title 6", :full_name => "Francis Lambert", :email => "francislambert@overplex.com", :phone => "890 547 2330", :contact => "francislambert@overplex.com", :section => "Sports", :coverage_type => "Action", :due_date => "2014-08-31", :due_time => "10:00", :details => "Officia officia dolore irure consequat.", :state => 1, :loc => '', :date => '', :time => '', :daily_member_id => DailyMember.last.id },
]
